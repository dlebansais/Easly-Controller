namespace EaslyController.Layout
{
    ...
    public abstract class LayoutStaticFrame : FocusStaticFrame, ILayoutStaticFrame
    {
        ...
        public abstract void Measure(ILayoutDrawContext drawContext, ILayoutCellView cellView, ILayoutCellViewCollection collectionWithSeparator, ILayoutCellView referenceContainer, double separatorLength, out Size size, out Padding padding);
        ...
        public abstract void Draw(ILayoutDrawContext drawContext, ILayoutCellView cellView, Point origin, Size size, Padding padding, bool isFocused);
        #endregion
