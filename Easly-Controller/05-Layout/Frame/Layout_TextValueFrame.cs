namespace EaslyController.Layout
{
    ...
    public class LayoutTextValueFrame : FocusTextValueFrame, ILayoutTextValueFrame
    {
        ...
        /// <param name="text">The text to print.</param>
        /// <param name="origin">The location where to start printing.</param>
        public virtual void Print(ILayoutPrintContext printContext, string text, Point origin)
        {
        ...
        {
            ControllerTools.AssertNoOverride(this, Type.FromTypeof<LayoutTextValueFrame>());
