namespace EaslyController.Layout
{
    ...
    internal class LayoutMoveBlockOperation : FocusMoveBlockOperation, ILayoutMoveBlockOperation
    {
        ...
        public LayoutMoveBlockOperation(INode parentNode, string propertyName, int blockIndex, int direction, Action<IWriteableOperation> handlerRedo, Action<IWriteableOperation> handlerUndo, bool isNested)
