namespace EaslyController.Layout
{
    ...
    internal class LayoutRemoveBlockViewOperation : FocusRemoveBlockViewOperation, ILayoutRemoveBlockViewOperation
    {
        ...
        public LayoutRemoveBlockViewOperation(INode parentNode, string propertyName, int blockIndex, Action<IWriteableOperation> handlerRedo, Action<IWriteableOperation> handlerUndo, bool isNested)
