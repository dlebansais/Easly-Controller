namespace EaslyController.Layout
{
    ...
    internal class LayoutInsertNodeOperation : FocusInsertNodeOperation, ILayoutInsertNodeOperation
    {
        ...
        public LayoutInsertNodeOperation(INode parentNode, string propertyName, int blockIndex, int index, INode node, Action<IWriteableOperation> handlerRedo, Action<IWriteableOperation> handlerUndo, bool isNested)
