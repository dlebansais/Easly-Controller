namespace EaslyController.Layout
{
    ...
    internal class LayoutRemoveBlockOperation : FocusRemoveBlockOperation, ILayoutRemoveBlockOperation
    {
        ...
        public LayoutRemoveBlockOperation(INode parentNode, string propertyName, int blockIndex, Action<IWriteableOperation> handlerRedo, Action<IWriteableOperation> handlerUndo, bool isNested)
