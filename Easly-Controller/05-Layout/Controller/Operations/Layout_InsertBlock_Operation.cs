namespace EaslyController.Layout
{
    ...
    internal class LayoutInsertBlockOperation : FocusInsertBlockOperation, ILayoutInsertBlockOperation
    {
        ...
        public LayoutInsertBlockOperation(Node parentNode, string propertyName, int blockIndex, IBlock block, Node node, System.Action<IWriteableOperation> handlerRedo, System.Action<IWriteableOperation> handlerUndo, bool isNested)
        ...
        {
            ControllerTools.AssertNoOverride(this, Type.FromTypeof<LayoutInsertBlockOperation>());
