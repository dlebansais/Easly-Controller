namespace EaslyController.Layout
{
    ...
    internal class LayoutInsertBlockOperation : FocusInsertBlockOperation, ILayoutInsertBlockOperation
    {
        ...
        public LayoutInsertBlockOperation(Node parentNode, string propertyName, int blockIndex, IBlock block, Node node, Action<IWriteableOperation> handlerRedo, Action<IWriteableOperation> handlerUndo, bool isNested)
