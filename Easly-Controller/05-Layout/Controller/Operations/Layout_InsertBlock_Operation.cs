namespace EaslyController.Layout
{
    ...
    internal class LayoutInsertBlockOperation : FocusInsertBlockOperation, ILayoutInsertBlockOperation
    {
        ...
        public LayoutInsertBlockOperation(INode parentNode, string propertyName, int blockIndex, IBlock block, INode node, Action<IWriteableOperation> handlerRedo, Action<IWriteableOperation> handlerUndo, bool isNested)
