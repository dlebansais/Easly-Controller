namespace EaslyController.Layout
{
    ...
    internal class LayoutMergeBlocksOperation : FocusMergeBlocksOperation, ILayoutMergeBlocksOperation
    {
        ...
        public LayoutMergeBlocksOperation(INode parentNode, string propertyName, int blockIndex, Action<IWriteableOperation> handlerRedo, Action<IWriteableOperation> handlerUndo, bool isNested)
