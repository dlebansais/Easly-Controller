namespace EaslyController.Layout
{
    ...
    /// </summary>
    public interface ILayoutEmptyCellViewCollection : IFocusEmptyCellViewCollection, ILayoutCellViewCollection
    {
    }
    ...
    /// A collection of cell views organized in a column.
    /// </summary>
    internal class LayoutEmptyCellViewCollection : FocusEmptyCellViewCollection, ILayoutEmptyCellViewCollection
    {
        #region Init
        /// <summary>
        ...
        #region Debugging
        /// <summary>
        /// Compares two <see cref="LayoutEmptyCellViewCollection"/> objects.
        /// </summary>
        ...
        public override bool IsEqual(CompareEqual comparer, IEqualComparable other)
        {
            ...
            if (!comparer.IsSameType(other, out LayoutEmptyCellViewCollection AsEmptyCellViewCollection))
