namespace EaslyController.Layout
{
    ...
    internal class LayoutPatternStateView : FocusPatternStateView, ILayoutPatternStateView
    {
        ...
        public LayoutPatternStateView(LayoutControllerView controllerView, ILayoutPatternState state)
        ...
        #region Debugging
        /// <summary>
        /// Compares two <see cref="LayoutPatternStateView"/> objects.
        /// </summary>
        ...
        {
            ControllerTools.AssertNoOverride(this, Type.FromTypeof<LayoutPatternStateView>());
