namespace EaslyController.Layout
{
    ...
    public class LayoutOperationReadOnlyList : FocusOperationReadOnlyList, IReadOnlyCollection<ILayoutOperation>, IReadOnlyList<ILayoutOperation>
    {
        ...
        /// <inheritdoc/>
        public new IEnumerator<ILayoutOperation> GetEnumerator() { var iterator = ((ReadOnlyCollection<IWriteableOperation>)this).GetEnumerator(); while (iterator.MoveNext()) { yield return (ILayoutOperation)iterator.Current; } }
