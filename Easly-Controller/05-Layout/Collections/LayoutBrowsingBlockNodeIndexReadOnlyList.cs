namespace EaslyController.Layout
{
    ...
    public class LayoutBrowsingBlockNodeIndexReadOnlyList : FocusBrowsingBlockNodeIndexReadOnlyList, IReadOnlyCollection<ILayoutBrowsingBlockNodeIndex>, IReadOnlyList<ILayoutBrowsingBlockNodeIndex>
    {
        ...
        /// <inheritdoc/>
        public new IEnumerator<ILayoutBrowsingBlockNodeIndex> GetEnumerator() { var iterator = ((ReadOnlyCollection<IReadOnlyBrowsingBlockNodeIndex>)this).GetEnumerator(); while (iterator.MoveNext()) { yield return (ILayoutBrowsingBlockNodeIndex)iterator.Current; } }
