namespace EaslyController.Layout
{
    ...
    public class LayoutIndexCollectionReadOnlyList : FocusIndexCollectionReadOnlyList, IReadOnlyCollection<ILayoutIndexCollection>, IReadOnlyList<ILayoutIndexCollection>
    {
        ...
        /// <inheritdoc/>
        public new IEnumerator<ILayoutIndexCollection> GetEnumerator() { var iterator = ((ReadOnlyCollection<IReadOnlyIndexCollection>)this).GetEnumerator(); while (iterator.MoveNext()) { yield return (ILayoutIndexCollection)iterator.Current; } }
