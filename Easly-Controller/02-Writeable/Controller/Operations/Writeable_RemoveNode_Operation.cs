namespace EaslyController.Writeable
{
    ...
    public class WriteableRemoveNodeOperation : WriteableRemoveOperation
    {
        ...
        /// </summary>
        private protected virtual WriteableInsertNodeOperation CreateInsertNodeOperation(int blockIndex, int index, Node node, Action<IWriteableOperation> handlerRedo, Action<IWriteableOperation> handlerUndo, bool isNested)
        {
