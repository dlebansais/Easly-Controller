namespace EaslyController.Writeable
{
    ...
    public class WriteableMergeBlocksOperation : WriteableOperation
    {
        ...
        public WriteableMergeBlocksOperation(Node parentNode, string propertyName, int blockIndex, Action<WriteableOperation> handlerRedo, Action<WriteableOperation> handlerUndo, bool isNested)
        ...
        /// </summary>
        private protected virtual WriteableSplitBlockOperation CreateSplitBlockOperation(int blockIndex, int index, IBlock block, Action<WriteableOperation> handlerRedo, Action<WriteableOperation> handlerUndo, bool isNested)
        {
