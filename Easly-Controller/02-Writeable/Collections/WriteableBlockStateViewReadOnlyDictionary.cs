namespace EaslyController.Writeable
{
    ...
    public class WriteableBlockStateViewReadOnlyDictionary : ReadOnlyBlockStateViewReadOnlyDictionary, ICollection<KeyValuePair<IWriteableBlockState, WriteableBlockStateView>>, IEnumerable<KeyValuePair<IWriteableBlockState, WriteableBlockStateView>>, IDictionary<IWriteableBlockState, WriteableBlockStateView>, IReadOnlyCollection<KeyValuePair<IWriteableBlockState, WriteableBlockStateView>>, IReadOnlyDictionary<IWriteableBlockState, WriteableBlockStateView>, IEqualComparable
    {
        ...
        void ICollection<KeyValuePair<IWriteableBlockState, WriteableBlockStateView>>.Add(KeyValuePair<IWriteableBlockState, WriteableBlockStateView> item) { throw new System.NotSupportedException("Collection is read-only."); }
        void ICollection<KeyValuePair<IWriteableBlockState, WriteableBlockStateView>>.Clear() { throw new System.NotSupportedException("Collection is read-only."); }
        ...
        bool ICollection<KeyValuePair<IWriteableBlockState, WriteableBlockStateView>>.Remove(KeyValuePair<IWriteableBlockState, WriteableBlockStateView> item) { throw new System.NotSupportedException("Collection is read-only."); }
        ...
        WriteableBlockStateView IDictionary<IWriteableBlockState, WriteableBlockStateView>.this[IWriteableBlockState key] { get { return (WriteableBlockStateView)this[key]; } set { throw new System.NotSupportedException("Collection is read-only."); } }
        ...
        void IDictionary<IWriteableBlockState, WriteableBlockStateView>.Add(IWriteableBlockState key, WriteableBlockStateView value) { throw new System.NotSupportedException("Collection is read-only."); }
        ...
        bool IDictionary<IWriteableBlockState, WriteableBlockStateView>.Remove(IWriteableBlockState key) { throw new System.NotSupportedException("Collection is read-only."); }
