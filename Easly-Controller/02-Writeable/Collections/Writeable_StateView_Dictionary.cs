...
namespace EaslyController.Writeable
{
    ...
    public class WriteableStateViewDictionary : ReadOnlyStateViewDictionary, ICollection<KeyValuePair<IWriteableNodeState, WriteableNodeStateView>>, IEnumerable<KeyValuePair<IWriteableNodeState, WriteableNodeStateView>>, IDictionary<IWriteableNodeState, WriteableNodeStateView>, IReadOnlyCollection<KeyValuePair<IWriteableNodeState, WriteableNodeStateView>>, IReadOnlyDictionary<IWriteableNodeState, WriteableNodeStateView>, IEqualComparable
    {
        ...
        void ICollection<KeyValuePair<IWriteableNodeState, WriteableNodeStateView>>.CopyTo(KeyValuePair<IWriteableNodeState, WriteableNodeStateView>[] array, int arrayIndex) { int i = 0; foreach (KeyValuePair<IWriteableNodeState, WriteableNodeStateView> Entry in ((ICollection<KeyValuePair<IWriteableNodeState, WriteableNodeStateView>>)this)) array[i++] = Entry; }
        ...
        IEnumerator<KeyValuePair<IWriteableNodeState, WriteableNodeStateView>> IEnumerable<KeyValuePair<IWriteableNodeState, WriteableNodeStateView>>.GetEnumerator() { return new List<KeyValuePair<IWriteableNodeState, WriteableNodeStateView>>(this).GetEnumerator(); }
