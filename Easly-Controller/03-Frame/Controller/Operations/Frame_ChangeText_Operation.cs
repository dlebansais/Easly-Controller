namespace EaslyController.Frame
{
    ...
    internal class FrameChangeTextOperation : WriteableChangeTextOperation, IFrameChangeTextOperation
    {
        ...
        public FrameChangeTextOperation(INode parentNode, string propertyName, string text, Action<IWriteableOperation> handlerRedo, Action<IWriteableOperation> handlerUndo, bool isNested)
