namespace EaslyController.Frame
{
    ...
    /// </summary>
    public interface IFrameInsertBlockOperation : IWriteableInsertBlockOperation, IFrameInsertOperation, IFrameOperation
    {
        /// <summary>
    ...
    internal class FrameInsertBlockOperation : WriteableInsertBlockOperation, IFrameInsertBlockOperation
    {
        ...
        public FrameInsertBlockOperation(Node parentNode, string propertyName, int blockIndex, IBlock block, Node node, System.Action<IWriteableOperation> handlerRedo, System.Action<IWriteableOperation> handlerUndo, bool isNested)
        ...
        {
            ControllerTools.AssertNoOverride(this, Type.FromTypeof<FrameInsertBlockOperation>());
