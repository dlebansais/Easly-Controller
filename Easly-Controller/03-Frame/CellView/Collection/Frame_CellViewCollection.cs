namespace EaslyController.Frame
{
    ...
    internal abstract class FrameCellViewCollection : FrameCellView, IFrameCellViewCollection
    {
        ...
        /// </summary>
        public static IFrameCellViewCollection Empty { get; } = new FrameEmptyCellViewCollection(FrameNodeStateView.Empty, null, new FrameCellViewList(), FrameFrame.FrameRoot);
