namespace EaslyController.Frame
{
    ...
    public class FrameBlockStateViewReadOnlyDictionary : WriteableBlockStateViewReadOnlyDictionary, ICollection<KeyValuePair<IFrameBlockState, FrameBlockStateView>>, IEnumerable<KeyValuePair<IFrameBlockState, FrameBlockStateView>>, IDictionary<IFrameBlockState, FrameBlockStateView>, IReadOnlyCollection<KeyValuePair<IFrameBlockState, FrameBlockStateView>>, IReadOnlyDictionary<IFrameBlockState, FrameBlockStateView>, IEqualComparable
    {
        ...
        void ICollection<KeyValuePair<IFrameBlockState, FrameBlockStateView>>.Add(KeyValuePair<IFrameBlockState, FrameBlockStateView> item) { throw new NotSupportedException("Collection is read-only."); }
        void ICollection<KeyValuePair<IFrameBlockState, FrameBlockStateView>>.Clear() { throw new NotSupportedException("Collection is read-only."); }
        ...
        bool ICollection<KeyValuePair<IFrameBlockState, FrameBlockStateView>>.Remove(KeyValuePair<IFrameBlockState, FrameBlockStateView> item) { throw new NotSupportedException("Collection is read-only."); }
        ...
        FrameBlockStateView IDictionary<IFrameBlockState, FrameBlockStateView>.this[IFrameBlockState key] { get { return (FrameBlockStateView)this[key]; } set { throw new NotSupportedException("Collection is read-only."); } }
        ...
        void IDictionary<IFrameBlockState, FrameBlockStateView>.Add(IFrameBlockState key, FrameBlockStateView value) { throw new NotSupportedException("Collection is read-only."); }
        bool IDictionary<IFrameBlockState, FrameBlockStateView>.ContainsKey(IFrameBlockState key) { return ContainsKey(key); }
        bool IDictionary<IFrameBlockState, FrameBlockStateView>.Remove(IFrameBlockState key) { throw new NotSupportedException("Collection is read-only."); }
