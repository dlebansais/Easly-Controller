namespace EaslyController.Frame
{
    ...
    public class FrameNodeStateReadOnlyDictionary : WriteableNodeStateReadOnlyDictionary, ICollection<KeyValuePair<IFrameIndex, IFrameNodeState>>, IEnumerable<KeyValuePair<IFrameIndex, IFrameNodeState>>, IDictionary<IFrameIndex, IFrameNodeState>, IReadOnlyCollection<KeyValuePair<IFrameIndex, IFrameNodeState>>, IReadOnlyDictionary<IFrameIndex, IFrameNodeState>
    {
        ...
        void ICollection<KeyValuePair<IFrameIndex, IFrameNodeState>>.Add(KeyValuePair<IFrameIndex, IFrameNodeState> item) { throw new NotSupportedException("Collection is read-only."); }
        void ICollection<KeyValuePair<IFrameIndex, IFrameNodeState>>.Clear() { throw new NotSupportedException("Collection is read-only."); }
        ...
        bool ICollection<KeyValuePair<IFrameIndex, IFrameNodeState>>.Remove(KeyValuePair<IFrameIndex, IFrameNodeState> item) { throw new NotSupportedException("Collection is read-only."); }
        ...
        IFrameNodeState IDictionary<IFrameIndex, IFrameNodeState>.this[IFrameIndex key] { get { return (IFrameNodeState)this[key]; } set { throw new NotSupportedException("Collection is read-only."); } }
        ...
        void IDictionary<IFrameIndex, IFrameNodeState>.Add(IFrameIndex key, IFrameNodeState value) { throw new NotSupportedException("Collection is read-only."); }
        bool IDictionary<IFrameIndex, IFrameNodeState>.ContainsKey(IFrameIndex key) { return ContainsKey(key); }
        bool IDictionary<IFrameIndex, IFrameNodeState>.Remove(IFrameIndex key) { throw new NotSupportedException("Collection is read-only."); }
