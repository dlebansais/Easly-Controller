...
namespace EaslyController.Frame
{
    ...
    /// Dictionary of IxxxIndex, IxxxNodeState
    /// </summary>
    public class FrameIndexNodeStateDictionary : Dictionary<IFrameIndex, IFrameNodeState>, IFrameIndexNodeStateDictionary
    {
        #region ReadOnly
        ...
        bool IDictionary<IReadOnlyIndex, IReadOnlyNodeState>.TryGetValue(IReadOnlyIndex key, out IReadOnlyNodeState value) { bool Result = TryGetValue((IFrameIndex)key, out IFrameNodeState Value); value = Value; return Result; }
        ...
        public bool TryGetValue(IFrameIndex key, out IReadOnlyNodeState value) { bool Result = TryGetValue(key, out IFrameNodeState Value); value = Value; return Result; }
        ...
        public void CopyTo(KeyValuePair<IFrameIndex, IReadOnlyNodeState>[] array, int arrayIndex) { throw new InvalidOperationException(); }
        ...
        bool IDictionary<IWriteableIndex, IWriteableNodeState>.TryGetValue(IWriteableIndex key, out IWriteableNodeState value) { bool Result = TryGetValue((IFrameIndex)key, out IFrameNodeState Value); value = Value; return Result; }
        ...
        public bool TryGetValue(IFrameIndex key, out IWriteableNodeState value) { bool Result = TryGetValue(key, out IFrameNodeState Value); value = Value; return Result; }
        ...
        public void CopyTo(KeyValuePair<IFrameIndex, IWriteableNodeState>[] array, int arrayIndex) { throw new InvalidOperationException(); }
