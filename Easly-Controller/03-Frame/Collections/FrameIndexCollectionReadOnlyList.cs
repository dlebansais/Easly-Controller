namespace EaslyController.Frame
{
    ...
    public class FrameIndexCollectionReadOnlyList : WriteableIndexCollectionReadOnlyList, IReadOnlyCollection<IFrameIndexCollection>, IReadOnlyList<IFrameIndexCollection>
    {
        ...
        /// <inheritdoc/>
        public new IEnumerator<IFrameIndexCollection> GetEnumerator() { var iterator = ((ReadOnlyCollection<IReadOnlyIndexCollection>)this).GetEnumerator(); while (iterator.MoveNext()) { yield return (IFrameIndexCollection)iterator.Current; } }
