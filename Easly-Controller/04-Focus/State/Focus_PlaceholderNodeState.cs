namespace EaslyController.Focus
{
        ...
        where IInner : IFocusInner<IFocusBrowsingChildIndex>
    {
        #region Init
        /// <summary>
        /// Gets the empty <see cref="FocusPlaceholderNodeState{IInner}"/> object.
        /// </summary>
        public static new FocusPlaceholderNodeState<IInner> Empty { get; } = new FocusPlaceholderNodeState<IInner>();

        /// <summary>
        /// Initializes a new instance of the <see cref="FocusPlaceholderNodeState{IInner}"/> class.
        /// </summary>
        protected FocusPlaceholderNodeState()
        {
        }
