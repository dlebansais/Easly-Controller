namespace EaslyController.Focus
{
    ...
    /// State of an replication pattern node.
    /// </summary>
    internal class FocusPatternState : FramePatternState, IFocusPatternState
    {
        #region Init
        /// <summary>
        /// Initializes a new instance of the <see cref="FocusPatternState"/> class.
        /// </summary>
        ...
        {
            ControllerTools.AssertNoOverride(this, typeof(FocusPatternState));
