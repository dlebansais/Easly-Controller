namespace EaslyController.Focus
{
    ...
    public class FocusVerticalListFrame : FrameVerticalListFrame, IFocusVerticalListFrame
    {
        #region Init
        /// <summary>
        /// Initializes a new instance of the <see cref="FocusVerticalListFrame"/> class.
        /// </summary>
        public FocusVerticalListFrame()
        {
        ...
        {
            ControllerTools.AssertNoOverride(this, Type.FromTypeof<FocusVerticalListFrame>());
