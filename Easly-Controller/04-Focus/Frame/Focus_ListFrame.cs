namespace EaslyController.Focus
{
    ...
    /// </summary>
    public interface IFocusListFrame : IFrameListFrame, IFocusNamedFrame, IFocusNodeFrameWithVisibility, IFocusFrameWithSelector, IFocusSelectorPropertyFrame
    {
    }
    ...
    public abstract class FocusListFrame : FrameListFrame, IFocusListFrame
    {
        #region Init
        /// <summary>
        /// Initializes a new instance of the <see cref="FocusListFrame"/> class.
        /// </summary>
        public FocusListFrame()
        {
