namespace EaslyController.Focus
{
    ...
    public class FocusOperationReadOnlyList : FrameOperationReadOnlyList, IReadOnlyCollection<IFocusOperation>, IReadOnlyList<IFocusOperation>
    {
        ...
        /// <inheritdoc/>
        public new IEnumerator<IFocusOperation> GetEnumerator() { var iterator = ((ReadOnlyCollection<IWriteableOperation>)this).GetEnumerator(); while (iterator.MoveNext()) { yield return (IFocusOperation)iterator.Current; } }
