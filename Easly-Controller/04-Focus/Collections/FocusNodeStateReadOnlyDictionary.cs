namespace EaslyController.Focus
{
    ...
    public class FocusNodeStateReadOnlyDictionary : FrameNodeStateReadOnlyDictionary, ICollection<KeyValuePair<IFocusIndex, IFocusNodeState>>, IEnumerable<KeyValuePair<IFocusIndex, IFocusNodeState>>, IDictionary<IFocusIndex, IFocusNodeState>, IReadOnlyCollection<KeyValuePair<IFocusIndex, IFocusNodeState>>, IReadOnlyDictionary<IFocusIndex, IFocusNodeState>
    {
        ...
        void ICollection<KeyValuePair<IFocusIndex, IFocusNodeState>>.Add(KeyValuePair<IFocusIndex, IFocusNodeState> item) { throw new NotSupportedException("Collection is read-only."); }
        void ICollection<KeyValuePair<IFocusIndex, IFocusNodeState>>.Clear() { throw new NotSupportedException("Collection is read-only."); }
        ...
        bool ICollection<KeyValuePair<IFocusIndex, IFocusNodeState>>.Remove(KeyValuePair<IFocusIndex, IFocusNodeState> item) { throw new NotSupportedException("Collection is read-only."); }
        bool ICollection<KeyValuePair<IFocusIndex, IFocusNodeState>>.IsReadOnly { get { return true; } }
        ...
        IFocusNodeState IDictionary<IFocusIndex, IFocusNodeState>.this[IFocusIndex key] { get { return (IFocusNodeState)this[key]; } set { throw new NotSupportedException("Collection is read-only."); } }
        ...
        void IDictionary<IFocusIndex, IFocusNodeState>.Add(IFocusIndex key, IFocusNodeState value) { throw new NotSupportedException("Collection is read-only."); }
        bool IDictionary<IFocusIndex, IFocusNodeState>.ContainsKey(IFocusIndex key) { return ContainsKey(key); }
        bool IDictionary<IFocusIndex, IFocusNodeState>.Remove(IFocusIndex key) { throw new NotSupportedException("Collection is read-only."); }
