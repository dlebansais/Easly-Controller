namespace EaslyController.Focus
{
    ...
    public class FocusFrameList : FrameFrameList, ICollection<IFocusFrame>, IEnumerable<IFocusFrame>, IList<IFocusFrame>, IReadOnlyCollection<IFocusFrame>, IReadOnlyList<IFocusFrame>
    {
        ...
        IEnumerator<IFocusFrame> IEnumerable<IFocusFrame>.GetEnumerator() { var iterator = ((List<IFrameFrame>)this).GetEnumerator(); while (iterator.MoveNext()) { yield return (IFocusFrame)iterator.Current; } }
