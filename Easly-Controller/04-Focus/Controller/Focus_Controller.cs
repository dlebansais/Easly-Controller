...
namespace EaslyController.Focus
{
    ...
    public class FocusController : FrameController, IFocusController
    {
        ...
        protected virtual void ExecuteReplaceWithCycle(IWriteableOperation operation)
        {
            ...
            ReplaceState(ReplaceWithCycleOperation, ReplaceWithCycleOperation.Inner);
        ...
        {
            ControllerTools.AssertNoOverride(this, typeof(FocusController));
            return new FocusInsertBlockOperation((IFocusBlockListInner<IFocusBrowsingBlockNodeIndex>)inner, blockIndex, block, node, handlerRedo, handlerUndo, isNested);
        }
        ...
        /// </summary>
        protected override IWriteableSplitBlockOperation CreateSplitBlockOperation(IWriteableBlockListInner<IWriteableBrowsingBlockNodeIndex> inner, IWriteableBrowsingExistingBlockNodeIndex nodeIndex, IBlock newBlock, Action<IWriteableOperation> handlerRedo, Action<IWriteableOperation> handlerUndo, bool isNested)
        {
            ControllerTools.AssertNoOverride(this, typeof(FocusController));
            return new FocusSplitBlockOperation((IFocusBlockListInner<IFocusBrowsingBlockNodeIndex>)inner, (IFocusBrowsingExistingBlockNodeIndex)nodeIndex, newBlock, handlerRedo, handlerUndo, isNested);
        }
        ...
        {
            ControllerTools.AssertNoOverride(this, typeof(FocusController));
            return new FocusExpandArgumentOperation((IFocusBlockListInner<IFocusBrowsingBlockNodeIndex>)inner, block, argument, handlerRedo, handlerUndo, isNested);
        }
        ...
        /// </summary>
        protected virtual IFocusReplaceWithCycleOperation CreateReplaceWithCycleOperation(IWriteableInner<IWriteableBrowsingChildIndex> inner, IFocusInsertionChildNodeIndexList cycleIndexList, int cyclePosition, Action<IWriteableOperation> handlerRedo, Action<IWriteableOperation> handlerUndo, bool isNested)
        {
            ControllerTools.AssertNoOverride(this, typeof(FocusController));
