namespace EaslyController.Focus
{
    ...
    internal class FocusRemoveNodeOperation : FrameRemoveNodeOperation, IFocusRemoveOperation
    {
        ...
        public FocusRemoveNodeOperation(Node parentNode, string propertyName, int blockIndex, int index, Action<WriteableOperation> handlerRedo, Action<WriteableOperation> handlerUndo, bool isNested)
