namespace EaslyController.Focus
{
    ...
    internal class FocusChangeBlockOperation : FrameChangeBlockOperation, IFocusOperation
    {
        ...
        public FocusChangeBlockOperation(Node parentNode, string propertyName, int blockIndex, ReplicationStatus replication, System.Action<IWriteableOperation> handlerRedo, System.Action<IWriteableOperation> handlerUndo, bool isNested)
