namespace EaslyController.Focus
{
    ...
    /// </summary>
    internal class FocusChangeBlockOperation : FrameChangeBlockOperation
    {
        #region Init
        /// <summary>
        ...
        public FocusChangeBlockOperation(Node parentNode, string propertyName, int blockIndex, ReplicationStatus replication, Action<WriteableOperation> handlerRedo, Action<WriteableOperation> handlerUndo, bool isNested)
