namespace EaslyController.Focus
{
    ...
    internal class FocusInsertNodeOperation : FrameInsertNodeOperation, IFocusInsertOperation
    {
        ...
        public FocusInsertNodeOperation(Node parentNode, string propertyName, int blockIndex, int index, Node node, Action<WriteableOperation> handlerRedo, Action<WriteableOperation> handlerUndo, bool isNested)
