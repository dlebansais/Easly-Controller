namespace EaslyController.Focus
{
    ...
    /// </summary>
    public interface IFocusReplaceOperation : IFrameReplaceOperation
    {
        /// <summary>
    ...
    internal class FocusReplaceOperation : FrameReplaceOperation, IFocusReplaceOperation
    {
        ...
        public FocusReplaceOperation(Node parentNode, string propertyName, int blockIndex, int index, Node newNode, Action<WriteableOperation> handlerRedo, Action<WriteableOperation> handlerUndo, bool isNested)
