...
namespace EaslyController.Focus
{
    ...
    public class FocusMergeBlocksOperation : FrameMergeBlocksOperation, IFocusMergeBlocksOperation
    {
        ...
        public FocusMergeBlocksOperation(IFocusBlockListInner<IFocusBrowsingBlockNodeIndex> inner, IFocusBrowsingExistingBlockNodeIndex nodeIndex, Action<IWriteableOperation> handlerRedo, bool isNested)
