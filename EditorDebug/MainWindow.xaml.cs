...
namespace EditorDebug
{
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        #region Test
        private void TextFormattedNumber()
        {
            int Value;
            ...
            Debug.Assert(!IntegerBase.Binary.IsValidNumber("", false));
            Debug.Assert(IntegerBase.Binary.IsValidNumber("0", false));
            Debug.Assert(IntegerBase.Binary.IsValidNumber("1", false));
            Debug.Assert(!IntegerBase.Binary.IsValidNumber("2", false));
            Debug.Assert(!IntegerBase.Binary.IsValidNumber("0120", false));
            Debug.Assert(!IntegerBase.Binary.IsValidNumber("010", false));
            Debug.Assert(!IntegerBase.Binary.IsValidNumber("011", false));
            Debug.Assert(IntegerBase.Binary.IsValidNumber("111", false));
            Debug.Assert(IntegerBase.Binary.IsValidNumber("110", false));
            Debug.Assert(IntegerBase.Binary.IsValidSignificand("111"));
            Debug.Assert(!IntegerBase.Binary.IsValidSignificand("110"));

            Debug.Assert(!IntegerBase.Octal.IsValidNumber("", false));
            Debug.Assert(IntegerBase.Octal.IsValidNumber("0", false));
            Debug.Assert(IntegerBase.Octal.IsValidNumber("1", false));
            Debug.Assert(!IntegerBase.Octal.IsValidNumber("8", false));
            Debug.Assert(!IntegerBase.Octal.IsValidNumber("0180", false));
            Debug.Assert(!IntegerBase.Octal.IsValidNumber("010", false));
            Debug.Assert(!IntegerBase.Octal.IsValidNumber("011", false));
            Debug.Assert(IntegerBase.Octal.IsValidNumber("111", false));
            Debug.Assert(IntegerBase.Octal.IsValidNumber("110", false));
            Debug.Assert(IntegerBase.Octal.IsValidSignificand("111"));
            Debug.Assert(!IntegerBase.Octal.IsValidSignificand("110"));

            Debug.Assert(!IntegerBase.Decimal.IsValidNumber("", false));
            Debug.Assert(IntegerBase.Decimal.IsValidNumber("0", false));
            Debug.Assert(IntegerBase.Decimal.IsValidNumber("1", false));
            Debug.Assert(!IntegerBase.Decimal.IsValidNumber("a", false));
            Debug.Assert(!IntegerBase.Decimal.IsValidNumber("01a0", false));
            Debug.Assert(!IntegerBase.Decimal.IsValidNumber("010", false));
            Debug.Assert(!IntegerBase.Decimal.IsValidNumber("011", false));
            Debug.Assert(IntegerBase.Decimal.IsValidNumber("111", false));
            Debug.Assert(IntegerBase.Decimal.IsValidNumber("110", false));
            Debug.Assert(IntegerBase.Decimal.IsValidSignificand("111"));
            Debug.Assert(!IntegerBase.Decimal.IsValidSignificand("110"));

            Debug.Assert(!IntegerBase.Hexadecimal.IsValidNumber("", false));
            Debug.Assert(IntegerBase.Hexadecimal.IsValidNumber("0", false));
            Debug.Assert(IntegerBase.Hexadecimal.IsValidNumber("1", false));
            Debug.Assert(!IntegerBase.Hexadecimal.IsValidNumber("g", false));
            Debug.Assert(!IntegerBase.Hexadecimal.IsValidNumber("01g0", false));
            Debug.Assert(!IntegerBase.Hexadecimal.IsValidNumber("010", false));
            Debug.Assert(!IntegerBase.Hexadecimal.IsValidNumber("011", false));
            Debug.Assert(IntegerBase.Hexadecimal.IsValidNumber("111", false));
            Debug.Assert(IntegerBase.Hexadecimal.IsValidNumber("110", false));
